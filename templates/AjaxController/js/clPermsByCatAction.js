...
{
    let img_path_clPermsByCat = source.img_path_clPermsByCat;
    let cldbid_clPermsByCat = source.cldbid_clPermsByCat;
    ...
    $('.sg-set-perm').click(function(event){
        ...
        let options = {
            id: id,
            sid: sid,
            cldbid: cldbid_clPermsByCat,
            block: block
        };

        if(src === img_path_clPermsByCat + '/16/add2.png')
        {
            $(this).clPermAdd(options, function(){
                    $(this).children().find('img').attr('src', img_path_clPermsByCat + '/16/substract.png');
        ...
        {
            $(this).clPermRem(options, function(){
                    $(this).children().find('img').attr('src', img_path_clPermsByCat + '/16/add2.png');
