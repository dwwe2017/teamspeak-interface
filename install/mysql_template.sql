...
CREATE TABLE IF NOT EXISTS `{PREFIX}api` (
  ...
  `client` varchar(510) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `secret` varchar(510) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `restricted_ip` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `limits` longtext COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `{PREFIX}config` (`id`, `name`, `shortcut`, `version`, `serial_key`, `last_update`, `last_update_check`, `auto_generate_proxy_classes`, `cache_driver`, `cache_type`, `cache_lifetime`, `created`, `icon_pkg`, `intelli_multiling`, `options`, `db_converted`, `timezone`, `cronjob_ajax`, `cronjob_crontab`, `log_level`, `date_format`, `maintenance`) VALUES
  (1, 'Tea(m)speak Interface', 'TSI', '{VERSION}', '{SERIAL_KEY}', CURRENT_TIMESTAMP, NULL, 0, 'files', 'dedicated', 3600, CURRENT_TIMESTAMP, '{ICON_PKG}', 0, NULL, 1, '{TIMEZONE}', 0, 0, 'WARNING', '{DATE_FORMAT}', NULL);

DROP TABLE IF EXISTS `{PREFIX}cronjob`;
CREATE TABLE IF NOT EXISTS `{PREFIX}cronjob` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `namespace` varchar(110) COLLATE utf8_unicode_ci DEFAULT NULL,
  `class` varchar(55) COLLATE utf8_unicode_ci DEFAULT NULL,
  `method` varchar(55) COLLATE utf8_unicode_ci DEFAULT NULL,
  `expression` varchar(510) COLLATE utf8_unicode_ci NOT NULL DEFAULT '*/15 * * * *',
  `description` varchar(510) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `{PREFIX}extensions` (
  ...
  `shortcut` varchar(11) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `description` varchar(510) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `version` varchar(55) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0.0.0',
  `serial_key` varchar(510) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `license_uri` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `update_uri` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `files` longtext COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `dir` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `init_class` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `init_method` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `menu_class` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `serverlist_option` int(1) NOT NULL DEFAULT '0',
  `last_update` datetime DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `icon_pkg` varchar(510) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'default',
  `settings` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `type` varchar(55) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'servers',
...
CREATE TABLE IF NOT EXISTS `{PREFIX}instances` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `reseller_id` int(11) DEFAULT NULL,
  `basis` varchar(11) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'ts3',
  `label` varchar(210) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `server_ip` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `query_port` int(11) NOT NULL DEFAULT '10011',
  `serveradmin` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `password` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `athp_link` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `tls` int(11) NOT NULL DEFAULT '0',
  `invoker` varchar(2) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'SA',
  `custom_icon` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `{PREFIX}instance_perms` (
  ...
  `permname` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `permdesc` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `{PREFIX}instance_perm_cats` (
  ...
  `permcathex` varchar(11) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `permcatname` varchar(55) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `{PREFIX}resellers` (
  ...
  `password` varchar(510) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `init_pw` varchar(510) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `first_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `last_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `email` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `query_nickname` varchar(55) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `lang` varchar(5) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'en_GB',
  `fixed_virtual_servers` longtext COLLATE utf8_unicode_ci NOT NULL,
  `icon_pkg` varchar(510) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'images/pkg-default',
  ...
  `additional_accesses` longtext COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `{PREFIX}simple_bots` (
  ...
  `bot_uid_last` varchar(55) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `bot_default_nickname` varchar(55) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  ...
  `bot_lang` varchar(11) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'en_GB',
  `bot_timezone` varchar(225) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Europe/Berlin',
...
CREATE TABLE IF NOT EXISTS `{PREFIX}stats` (
  ...
  `type` varchar(55) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `{PREFIX}users` (
  ...
  `query_nickname` varchar(55) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `lang` varchar(5) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'en_GB',
  `fixed_virtual_servers` varchar(510) COLLATE utf8_unicode_ci NOT NULL DEFAULT '[[]]',
  `reg_date` datetime DEFAULT NULL,
  `active` int(1) NOT NULL DEFAULT '1',
  `icon_pkg` varchar(510) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'images/pkg-default',
  `reseller_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `{PREFIX}user_groups` (
  ...
  `virtualserver_permissions` longtext COLLATE utf8_unicode_ci,
  `virtualserver_modify` longtext COLLATE utf8_unicode_ci,
  `virtualserver_channel_modify` longtext COLLATE utf8_unicode_ci,
  `tsi_permissions` longtext COLLATE utf8_unicode_ci,
  `reseller_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
ALTER TABLE `{PREFIX}api`
  ADD CONSTRAINT `FK_FADB47B391E6A19D` FOREIGN KEY (`reseller_id`) REFERENCES `{PREFIX}resellers` (`id`);

ALTER TABLE `{PREFIX}instances`
  ADD CONSTRAINT `FK_EB01953991E6A19D` FOREIGN KEY (`reseller_id`) REFERENCES `{PREFIX}resellers` (`id`) ON DELETE SET NULL;

ALTER TABLE `{PREFIX}instance_perms`
  ADD CONSTRAINT `FK_97ABD78D3A51721D` FOREIGN KEY (`instance_id`) REFERENCES `{PREFIX}instances` (`id`),
  ADD CONSTRAINT `FK_97ABD78DB12C8CFA` FOREIGN KEY (`permcatid`) REFERENCES `{PREFIX}instance_perm_cats` (`id`);

ALTER TABLE `{PREFIX}instance_perm_cats`
  ADD CONSTRAINT `FK_73C156013A51721D` FOREIGN KEY (`instance_id`) REFERENCES `{PREFIX}instances` (`id`);

ALTER TABLE `{PREFIX}resellers`
  ADD CONSTRAINT `FK_3E370E3FE54D947X` FOREIGN KEY (`group_id`) REFERENCES `{PREFIX}user_groups` (`id`);

ALTER TABLE `{PREFIX}simple_bots`
  ADD CONSTRAINT `FK_E48039FD3A51721D` FOREIGN KEY (`instance_id`) REFERENCES `{PREFIX}instances` (`id`);

ALTER TABLE `{PREFIX}users`
  ADD CONSTRAINT `FK_3C439D5691E6A19D` FOREIGN KEY (`reseller_id`) REFERENCES `{PREFIX}resellers` (`id`),
  ADD CONSTRAINT `FK_9DB84490FE54D947` FOREIGN KEY (`group_id`) REFERENCES `{PREFIX}user_groups` (`id`);

ALTER TABLE `{PREFIX}user_groups`
  ADD CONSTRAINT `FK_AFE189F491E6A19D` FOREIGN KEY (`reseller_id`) REFERENCES `{PREFIX}resellers` (`id`);
